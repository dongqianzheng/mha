Since Google Code no longer accepts new file uploads, newer MHA versions (from 0.56) will be hosted on [Google Drive](https://googledrive.com/host/0B1lu97m8-haWeHdGWXp0YVVUSlk/) instead.
